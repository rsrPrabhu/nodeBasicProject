...
<details>
  ...
  <ol>
    <li>
      <a href="#about-the-project">About nodeBasic Project</a>
      <ul>
...
<!-- ABOUT THE PROJECT -->
## About nodeBasicProject Project

This Node project eloborates all the features , such as controller , HTML file , data fetching in Node Js  .

Here's why:
* Learned the depth topics of Node Js concepts .
...
1. Clone the repo
   ```sh
   https://github.com/rsrPrabhu/nodeBasicProject.git
   ```
